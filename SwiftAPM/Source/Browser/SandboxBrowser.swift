...
public func openSandBox(_ window: UIWindow) {
    ...
    sandboxBrowser.didCloseBrowser = {
        window.isHidden = true
        oldKeyWindow?.makeKeyAndVisible()
    }
    
    window.rootViewController = sandboxBrowser
...
public struct FileItem {
    ...
    var image: UIImage {
        ...
        guard
            ...
            let file = resBundle.path(forResource: type.fileName, ofType: "png"),
...
public class SandboxBrowser: UINavigationController {
    ...
    open var didCloseBrowser: (() -> ())? {
        didSet {
            fileListVC?.didCloseBrowser = didCloseBrowser
        }
    }
